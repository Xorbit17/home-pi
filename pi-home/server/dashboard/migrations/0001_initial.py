    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(default='Europe/Brussels', max_length=64)),
                ('default_mode', models.CharField(choices=[('news', 'Newspaper'), ('photo', 'Photo'), ('dashboard', 'Dashboard')], default='photo', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('news', 'Newspaper'), ('photo', 'Photo'), ('dashboard', 'Dashboard')], default='photo', max_length=16)),
                ('active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
