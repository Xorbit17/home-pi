    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('CALENDAR', 'Get calendar'), ('RSS', 'Get RSS'), ('WEATHER', 'Get weather'), ('PUSH', 'Push to displays'), ('ART', 'Generate art'), ('NEWSPAPER', 'Generate newspaper'), ('CLASSIFY', 'Classify image')], max_length=64)),
                ('cron', models.CharField(help_text="Cron format, e.g. '0 5 * * *'", max_length=64)),
