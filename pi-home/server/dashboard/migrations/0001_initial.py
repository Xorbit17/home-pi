# Generated by Django 5.2.5 on 2025-08-23 18:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('CALENDAR', 'Get calendar'), ('RSS', 'Get RSS'), ('WEATHER', 'Get weather'), ('PUSH', 'Push to displays'), ('ART', 'Generate art'), ('NEWSPAPER', 'Generate newspaper'), ('CLASSIFY', 'Classify image'), ('MANUAL_TRIGGER', 'Manually triggered')], max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='executions', to='dashboard.job')),
            ],
        ),
        migrations.CreateModel(
            name='JobLogEntry',
